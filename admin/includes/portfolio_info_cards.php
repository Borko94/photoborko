<div class="dashboard">
    <div class="dashboard__item dashboard__item--col">
        ...
        <div class="card__details">
            <?php
            $all_count_post_query = "SELECT * FROM portfolio_posts";
    ...
    <div class="dashboard__item dashboard__item--col">
        ...
        <div class="card__details">
            <?php
            $all_count_comments_query = "SELECT * FROM portfolio_comments";
    ...
    <div class="dashboard__item dashboard__item--col">
        ...
        <div class="card__details">
            <?php
            $all_count_views_query = "SELECT SUM(post_views_count) AS SUM FROM portfolio_posts";
