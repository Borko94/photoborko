...
<main class="admin__main">
      ...
      <table class="table table__wrapper">
          ...
          <tbody>
          <?php 
            $get_comment_post_id = $_GET['id'];
            $select_comments_query = "SELECT * FROM blog_comments WHERE comment_post_id = $get_comment_post_id";
            ...
            <tr class="table__row">
              ...
              <?php 
                $select_comment_post = "SELECT * FROM blog_posts WHERE post_id = '{$comment_post_id}'";
              ...
              <td data-label="Author" class="table__data"><a href="blog_comments.php?approve=<?php echo $comment_id; ?>">Approve</a></td>
              <td data-label="Author" class="table__data"><a href="blog_comments.php?unapprove=<?php echo $comment_id; ?>">Unapprove</a></td>
              ...
              <td data-label="Obrisi" class="table__data">
                <a href="blog_comments.php?delete_comment=<?php echo $comment_id; ?>" class="table__link">
...
if(isset($_GET['delete_comment'])) {
    ...
    $delete_comment_query = "DELETE FROM blog_comments WHERE comment_id = '{$delete_comment_id}'";
    ...
    if(!$run_delete_comment_query) {
        ...
        header("Location: blog_comments.php?commentDeletedSuccsfully");
    }
}
...
if(isset($_GET['approve'])) {
    ...
    $query_approve_comment = "UPDATE blog_comments SET comment_status = 'approved' WHERE comment_id = {$approve_id}";
    $run_approve_comment = mysqli_query($conn, $query_approve_comment);

    if(!$run_approve_comment) {
        die("Error approving comment");
    }else {
        header("Location: blog_comments.php?commentApproved");
    }
}
...
if(isset($_GET['unapprove'])) {
    ...
    $query_unapprove_comment = "UPDATE blog_comments SET comment_status = 'unapproved' WHERE comment_id = {$unapprove_id}";
    ...
    if(!$run_query_unapprove_comment) {
        ...
        header("Location: blog_comments.php?commentUnapproved");
    }
}
