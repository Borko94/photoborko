...
<table class="table table__wrapper">
    ...
    <tbody>
    <?php 
        $blog_post_category_id = $_GET['post_id'];
        $query_select_blog_posts = "SELECT * FROM blog_posts WHERE post_category_id = $blog_post_category_id ORDER BY post_id DESC";
        ...
        <tr class="table__row">
            ...
            ?><a href="blog.php?source=blog_posts_by_category&post_id=<?php echo $post_category_id;?>"><?php echo $cat_title;?></a></td>
...
if(isset($_GET['delete_blog_post'])) {
    ...
    if(!$run_delete_post_query) {
        ...
        header("Location: blog.php?postDeletedSuccsfully");
    }
}
