<table class="table table__wrapper">
    ...
    <tbody>
        <tr class="table__row">
        <td data-label="ID" class="table__data">1</td>
        <td data-label="ID" class="table__data">Dobrilo Jelic</td>
        <td data-label="Naslov" class="table__data">065/123-456</td>
        <td data-label="Date" class="table__data">dobrilo@mail.com</td>
        <td data-label="Author" class="table__data">Informacije</td>
        <td data-label="Author" class="table__data">Kategorija</td>
