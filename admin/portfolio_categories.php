...
<main class="admin__main">
    <h3 class="mb-2">Portfolio kategorije</h3>
    <div class="container">
        <div class="row ">
            <div class="col-6-md col-12-xs">
                ...
                if(isset($_GET['edit'])) {
                    ...
                    $select_cat = "SELECT * FROM portfolio_categories WHERE portfolio_category_id = '{$edit_cat_id}'";
                ...
                if(isset($_POST['update_category'])) {
                    ...
                    $update_category_query = "UPDATE portfolio_categories SET portfolio_category_name = '{$cat_title_new}' WHERE portfolio_category_id = '$edit_cat_id'";
                    ...
                    if(!$run_update_category_query) {
                        ...
                        header("Location: portfolio_categories.php?categoryUpdatedSuccessfully");
                    }
                }
            }
            ?>
                    ...
                    <tbody>
                        ...
                        <tr class="table__row">
                            ...
                            <td data-label="Edituj" class="table__data">
                                <a href="portfolio_categories.php?edit=<?php echo $cat_id; ?>" class="table__link">
                            ...
                            <td data-label="Obrisi" class="table__data">
                                <a href="portfolio_categories.php?delete=<?php echo $cat_id; ?>" class="table__link">
...
if(isset($_POST['add_category'])) {
    ...
    $query = "INSERT INTO portfolio_categories (portfolio_category_name, portfolio_category_date) VALUES ('{$cat_title}', now())";
    $run_query = mysqli_query($conn, $query);

    if(!$run_query){
        echo "error inserting data into database";
    }else {
        header("Location: portfolio_categories.php?newCategoryAdded");
    }
}
?>
...
if(isset($_GET['delete'])) {
    ...
    $delete_cat_query = "DELETE FROM portfolio_categories WHERE portfolio_category_id = '{$delete_cat_id}'";
    ...
    if(!$run_delete_cat_query) {
        ...
        header("Location: portfolio_categories.php?deletedCategorySuccessfully");
    }
}
?>
